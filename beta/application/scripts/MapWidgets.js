...
function DistanceWidget(opt_options) {
  ...
  marker.bindTo('visible', this, 'draggable');

  // Create a new radius widget
  var radiusWidget = new RadiusWidget({
    distance: opt_options.distance,
    resizable: opt_options.resizable
  });
  ...
  // propagate radius widget clicks
  google.maps.event.addListener(radiusWidget, 'click', function() {
 ...
 * @constructor
 */
function RadiusWidget(opt_options) {
...
RadiusWidget.prototype.addSizer_ = function() {
  ...
  sizer.bindTo('visible', this, 'resizable');
...
window.DistanceWidget = DistanceWidget;
